...
A sub-class is a class which inherits from another class called super class. Sub-class can access all public and protected methods and fields of its super class. ','Java Interview OOP');
INSERT INTO flashcards(user_id,question_side, answer_side , keywords) VALUES('2', 'What is an infinite Loop? How infinite loop is declared? ','An infinite loop runs without any condition and runs infinitely. An infinite loop can be broken by defining any breaking logic in the body of the statement blocks. 
																			 for (;;)','Java loops');
INSERT INTO flashcards(user_id,question_side, answer_side , keywords) VALUES('2', 'What are the various access specifiers for Java classes? ','In Java, access specifiers are the keywords used before a class name which defines the access scope. The types of access specifiers for classes are: 
...
3. Default: Method,Field,class can be accessed only from the same package and not from outside of its native package. 4. Private: Method,Field can be accessed from the same class to which they belong. ','Java Interview OOP');
...
INSERT INTO flashcards(user_id,question_side, answer_side , keywords) VALUES('2', 'What are Loops in Java? What are three types of loops? ','1) For Loops 
...
3) Do While Loops 
Do While Loop is same as While loop with only difference that condition is checked after execution of block of statements. Hence in case of do while loop, statements are executed at least once. ','Java Interview Loops');
...
INSERT INTO flashcards(user_id,question_side, answer_side , keywords) VALUES('2','What is ternary operator?','Ternary operator , also called conditional operator is used to decide which value to assign to a variable based on a Boolean value evaluation. Its denoted as ? 
In the below example, if rank is 1, status is assigned a value of “Done" else “Pending” 
public class conditionTest { 
public static void main(String args[]) { 
String status; int rank = 3; status = (rank == 1) ? "Done" : "Pending"; System.out.println(status); ','Java Operator ');
INSERT INTO flashcards(user_id,question_side, answer_side , keywords) VALUES('2','How can you generate random numbers in Java? ','Using Math.random() you can generate random numbers in the range greater 
than or equal to 0.1 and less than 1.0 
. Using Random class in package java.util.','Java Math');
